...
namespace FargowiltasSouls.Content.Patreon.Potato
{
    public class RazorContainer : PatreonModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            {
                Projectile.NewProjectile(player.GetSource_Accessory(Item), player.Center, new Vector2(Main.rand.Next(-2, 2), -2), ModContent.ProjectileType<RazorBlade>(), 10, 2f, player.whoAmI);
            }
        }
