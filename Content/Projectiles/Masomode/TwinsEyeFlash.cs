...
namespace FargowiltasSouls.Content.Projectiles.Masomode
{
    ...
    public class TwinsEyeFlash : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (npc.TypeAlive(NPCID.Retinazer) || npc.TypeAlive(NPCID.Spazmatism))
            {
        ...
        public static Vector2 Offset(NPC npc) => (npc.rotation + MathHelper.PiOver2).ToRotationVector2() * npc.width * 0.45f;
