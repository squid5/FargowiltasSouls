    ...
    public partial class FargowiltasSouls : Mod
    {
        ...
        public override void PostSetupContent()
        {
            try
            {
                ...
                fargos.Call("AddSummon", 2.79f, "FargowiltasSouls", "CoffinSummon2", new Func<bool>(() => WorldSavingSystem.DownedBoss[(int)WorldSavingSystem.Downed.CursedCoffin]), Item.buyPrice(0, 9));
